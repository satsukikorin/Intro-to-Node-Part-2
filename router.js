...
module.exports = function(app){
     ...
     app.get('/',function(req,res){
          ...
          var categoricalPromise = categoryService.get();

          Promise.resolve(categoricalPromise).then(function(categories){
          ...
          .catch(function(err) {
               ...
               console.error(err);
        		res.render('index.html', {error: 'Sorry, there was an error. Please hit Back in your browser and try again.'});
          });
     ...
     app.get("/fantasy", function(req, res) {
          ...
          Promise.all([getCategories,getBooks]).then(function(values) {
               ...
               // "values" is an array, with each element in that array
               // being the object returned by those 2 promises, in that
               // order.  So, we can pull those out with "shift" and
               // get the things we want to work with...
